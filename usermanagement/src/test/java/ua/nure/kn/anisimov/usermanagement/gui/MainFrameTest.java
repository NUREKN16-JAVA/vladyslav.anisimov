package ua.nure.kn.anisimov.usermanagement.gui;
...
import ua.nure.kn.anisimov.usermanagement.db.MockDaoFactory;
import ua.nure.kn.anisimov.usermanagement.util.Messages;
...
public class MainFrameTest extends JFCTestCase {
    ...
    protected void setUp() throws Exception {
        try {
            ...
            User expectedUser = new User(new Long(1001L), "John", "Doe", DATE);
    ...
    public void testEditUser() {
        try {  
            ...
            User expectedUser = new User(new Long(1001), "John", "Doe", DATE);
